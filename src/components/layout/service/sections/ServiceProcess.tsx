...
export const ServiceProcess = ({ service }: ServiceProcessProps) => {
  ...
  // English-only default process steps
  const defaultSteps = [
    {
      title: 'Analysis',
    ...
    {
      title: 'Strategy',
      description: 'Develop a tailored digital marketing strategy',
      items: [
        'Goal setting',
        'Channel selection',
        'Budget planning'
    ...
    {
      title: 'Execution',
      description: 'Implement the strategy with expert precision',
      items: [
        'Content creation',
        'Campaign launch',
    ...
    {
      title: 'Reporting',
      description: 'Transparent reporting and actionable insights',
      items: [
