  ...
  const contentSections = [
    {
      ...
      mainContent: {
        ...
        description: "Engage Bangalore's vibrant Instagram community"
      }
    },
    {
      ...
      mainContent: {
        ...
        description: "English content creation for Bangalore market"
      }
    },
    {
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-500 text-transparent bg-clip-text">
              Strategic {service.content.title.split(' in ')[0]} for Bangalore Businesses
            </h2>
