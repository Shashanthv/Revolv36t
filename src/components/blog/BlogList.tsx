...
interface BlogListProps {
  ...
  locale?: string; // locale is now optional and defaults to 'en'
}

export default function BlogList({ initialPosts, locale = 'en' }: BlogListProps) {
  ...
  const loadMorePosts = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/posts?page=${nextPage}&locale=en`);
