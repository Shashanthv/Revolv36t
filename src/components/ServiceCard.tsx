...
export const ServiceCard: React.FC<ServiceCardProps> = ({ service, onClick }) => {
  return (
    <div
      className="group relative bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden"
      onClick={onClick}
      tabIndex={0}
      role="button"
    ...
    >
      ...
      <div className="relative p-8 border border-gray-100 dark:border-gray-800 rounded-2xl group-hover:border-purple-500 transition-all duration-300">
        ...
        <span className="inline-flex items-center text-purple-600 dark:text-purple-400 group-hover:text-purple-500 transition duration-300">
          Discover More 
